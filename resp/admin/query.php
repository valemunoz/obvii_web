...
if(substr(strtolower($data_server[0]),0,strlen(PATH_SITE_ADMIN))==PATH_SITE_ADMIN)
{
	...
	{		
		...
		<table border=1 id="table_resul" class="bordered">
			...
			<tr><td>Mail</td><td><input id="mail_us" name="mail_us" type="text" value="<?=$usuario[0][3]?>"></td></tr>		
			<tr><td>Pais</td>
						<td>
	...
	{
		updateCli("pais='".$_REQUEST['pais']."', mail='".$_REQUEST['mail']."', nombre='".$_REQUEST['nom']."'",decrypt($_REQUEST['id'],ENCRIPTACION));
